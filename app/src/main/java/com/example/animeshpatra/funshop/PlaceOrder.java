        ...
        rdg_select.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                if (checkedId == R.id.rdb_cashPay){
                    ...
                    startActivity( new Intent(PlaceOrder.this, CartItems.class));
                }
        ...
        btn_pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(amount.equals("") || emailId.equals("") || cvv.equals("") || cardnumber.equals("") || expiry.equals("")) {
                    Toast.makeText(PlaceOrder.this, "Please fill up the details", Toast.LENGTH_SHORT).show();
                }else{
                    Response.Listener<String> listener = new Response.Listener<String>(){
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                Toast.makeText(PlaceOrder.this, message, Toast.LENGTH_LONG).show();
